...
(function($) {
  ...
  */
  ...
  test('is chainable', 1, function() {
    ...
    strictEqual(this.elems.rot13(), this.elems, 'should be chainable');
  });
  ...
  module('jQuery.fn.rot13: pure text', {
    setup: function() {
      this.normal = $('#qunit-fixture p.normal').text('ABCDEFGHIJKLMNOPQRSTUVWXYZ!%*#@abcdefghijklmnopqrstuvwxyz');
      this.encoded = $('#qunit-fixture p.encoded').text('NOPQRSTUVWXYZABCDEFGHIJKLM!%*#@nopqrstuvwxyzabcdefghijklm');
    }
  });
  ...
  module('jQuery.fn.rot13: HTML', {
    setup: function() {
      this.normal = $('#qunit-fixture p.normal').html('ABCDEFGHIJKL<b>MNOPQRSTUVWXYZ!%*#@abc</b>defghijklmnopqrstuvwxyz');
      this.encoded = $('#qunit-fixture p.encoded').html('NOPQRSTUVWXY<b>ZABCDEFGHIJKLM!%*#@nop</b>qrstuvwxyzabcdefghijklm');
    }
  });
